...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card position-relative">
            <div class="card-body">
                <div id="detailedReports" class="pt-2 carousel slide detailed-report-carousel position-static"
                    data-ride="carousel">
                                            ...
                                            <div class="mt-3 mb-3 table-responsive mb-md-0">
                                                <table class="table table-borderless report-table">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="mb-0 font-weight-bold">713</h5>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="mb-0 font-weight-bold">583</h5>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="mb-0 font-weight-bold">924</h5>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="mb-0 font-weight-bold">664</h5>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="mb-0 font-weight-bold">560</h5>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="mb-0 font-weight-bold">793</h5>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mt-2 mb-0 add-items d-flex">
                    ...
                    <button class="bg-transparent add btn btn-icon text-primary todo-list-add-btn"><i
                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <p class="mb-0"><span class="mr-2 font-weight-bold">65</span>(2.15%)</p>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="mb-0"><span class="mr-2 font-weight-bold">54</span>(3.25%)</p>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="mb-0"><span class="mr-2 font-weight-bold">22</span>(2.22%)</p>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="mb-0"><span class="mr-2 font-weight-bold">46</span>(3.27%)</p>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="mb-0"><span class="mr-2 font-weight-bold">17</span>(1.25%)</p>
                                </td>
                            ...
                            <tr>
                                <td class="pl-0">Nevada</td>
                                <td>
                                    <p class="mb-0"><span class="mr-2 font-weight-bold">52</span>(3.11%)</p>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="pb-0">
                                    <p class="mb-0"><span class="mr-2 font-weight-bold">25</span>(1.32%)</p>
                                </td>
                                <td class="pb-0">14</td>
                            </tr>
                        </tbody>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="text-white col-8">
                                <h3>34040</h3>
                                <p class="mb-0 text-white font-weight-500">The total number of sessions within the date
