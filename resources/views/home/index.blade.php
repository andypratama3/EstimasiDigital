...
@section('content')
    ...
    <section class="gj do ir hj sp jr i pg">
      ...
      <div class="xc fn zd/2 2xl:ud-w-187.5 bd 2xl:ud-h-171.5 h q r">
        ...
        <img src="{{ asset('assets_home/images/hero.png')}}" alt="Woman" class="h q r ua" />
      </div>
    ...
    <section class="i pg ji gp uq">
      ...
      <img src="{{ asset('assets_home/images/shape-08.svg')}}" alt="Shape Bg" class="h q r" />
      <img src="{{ asset('assets_home/images/shape-09.svg')}}" alt="Shape" class="of h y z/2" />
      <img src="{{ asset('assets_home/images/shape-10.svg')}}" alt="Shape" class="h _ aa" />
      <img src="{{ asset('assets_home/images/shape-11.svg')}}" alt="Shape" class="of h m ba" />
        ...
        <div class="wc qf pn xo gg cp">
          ...
          <div class="animate_top rj">
            <div class="c i pg z-1">
              <img class="vd" src="{{ asset('assets_home/images/team-01.png')}}" alt="Team" />
          ...
          <div class="animate_top rj">
            <div class="c i pg z-1">
              <img class="vd" src="{{ asset('assets_home/images/team-02.png')}}" alt="Team" />
          ...
          <div class="animate_top rj">
            <div class="c i pg z-1">
              <img class="vd" src="{{ asset('assets_home/images/team-03.png')}}" alt="Team" />
        ...
        <div class="wc qf pn xo ng">
          ...
          <a href="{{ route('buku.index') }}">
              <div class="animate_top sg oi pi zq ml il am cn _m">
                <img src="{{ asset('assets_home/images/icon-04.svg')}}" alt="Icon" />
                <h4 class="ek zj kk wm nb _b">Buku Digital</h4>
          ...
          <div class="animate_top sg oi pi zq ml il am cn _m">
            ...
            <h4 class="ek zj kk wm nb _b">Jurnal</h4>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In convallis tortor.</p>
          </div>
        ...
        <div class="projects-wrapper tc -ud-mx-5">
          ...
          <div class="project-item wi fb vd jn/2 to/3 branding ecommerce">
            <div class="c i pg sg z-1">
              <img src="{{ asset('assets_home/images/project-01.png')}}" alt="Project" />

              <div class="z-10 h s r df nl kl im tc sf wf xf vd yc sg al hh/20">
          ...
          <div class="project-item wi fb vd jn/2 to/3 digital">
            <div class="c i pg sg z-1">
              <img src="{{ asset('assets_home/images/project-02.png')}}" alt="Project" />
          ...
          <div class="project-item wi fb vd jn/2 to/3 branding ecommerce">
            <div class="c i pg sg z-1">
              <img src="{{ asset('assets_home/images/project-04.png')}}" alt="Project" />
          ...
          <div class="project-item wi fb vd vo/3 digital ecommerce">
            <div class="c i pg sg z-1">
              <img src="{{ asset('assets_home/images/project-03.png')}}" alt="Project" />
    ...
    <section id="support" class="i pg fh rm ji gp uq">
      ...
      <div class="i va bb ye ki xn wq jb mo">
        <div class="tc uf sn tf rn un zf xl:gap-10">
          <div class="w-full animate_top mn/5 to/3 vk sg hh sm yh rq i pg">
            <!-- Bg Shapes -->
    ...
    <section class="i pg gh ji">
      <!-- Bg Shape -->
      <img class="h p q" src="{{ asset('assets_home/images/shape-16.svg')}}" alt="Bg Shape" />

      <div class="z-10 bb ye i ki xn dr">
